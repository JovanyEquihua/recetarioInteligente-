            ...
            >
              <Dialog.Panel className="w-full max-w-md bg-white rounded-2xl p-6 shadow-xl transform transition-all relative">
                ...
                <form className="mt-4 space-y-3" onSubmit={handleSubmit}>
                  ...
                  />
                  <Link href="/restablecer-contrasena" className="text-indigo-500 hover:underline">
                    <p className="mt-4 text-sm text-center text-gray-600 " onClick={closeModal}>
                ...
                <p className="mt-4 text-sm text-center text-gray-600"  onClick={closeModal}>
                  ¿No tienes cuenta?{" "}
                  <Link href="/registrarse" className="text-indigo-500 hover:underline">
                    Regístrate
                  </Link>
                </p>
              </Dialog.Panel>
