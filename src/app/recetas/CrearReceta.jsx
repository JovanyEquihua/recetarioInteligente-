...
export default function CrearReceta({ onSave }) {
  ...
  const [tempImage, setTempImage] = useState(null); // Estado temporal para la imagen en proceso
  ...
  const [nuevoIngrediente, setNuevoIngrediente] = useState({
    nombre: "",
    cantidad: "",
    tipo: "Verduras", // Valor por defecto
  });
  useEffect(() => {
  ...
  const handleImageUpload = async (e) => {
    ...
    // Mostrar imagen temporal mientras se sube
    ...
    try {
      ...
      setTempImage(null); // Limpiar imagen temporal
    } catch (error) {
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-2 mb-2">
              ...
              <button
                ...
                className="px-4 bg-[#8B1C62] text-white rounded-md hover:bg-[#7a1755] flex items-center justify-center gap-1"
              >
              ...
              >
                ...
                <button
                  ...
                  onClick={() =>
                    setFormData({
                      ...formData,
                      pasosPreparacion: formData.pasosPreparacion.filter(
                        (_, i) => i !== idx
                      ),
                    })
                  }
                ...
                onClick={() => {
                  if (nuevoPaso.paso) {
                    setFormData({
                      ...formData,
                      pasosPreparacion: [
                        ...formData.pasosPreparacion,
                        {
                          paso: nuevoPaso.paso,
                          tiempo: nuevoPaso.tiempo
                            ? parseInt(nuevoPaso.tiempo)
                            : null,
                        },
                      ],
                    });
